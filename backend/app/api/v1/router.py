...
from app.api.v1.routes import categories, transactions, investments, goals, dashboard, reports, ai, months
...
api_router.include_router(months.router, prefix="/months", tags=["Months"], **_protected)
